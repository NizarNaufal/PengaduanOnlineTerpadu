...
public class MaterialSpinner extends TextView {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    setBackgroundResource(R.drawable.sk_selector);
    ...
    if (!hideArrow) {
      arrowDrawable = Utils.getDrawable(context, R.drawable.sk_arrow).mutate();
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      popupWindow.setBackgroundDrawable(Utils.getDrawable(context, R.drawable.sk_drawable));
    } else {
      popupWindow.setBackgroundDrawable(Utils.getDrawable(context, R.drawable.sk_drop_down_shadow));
    }
