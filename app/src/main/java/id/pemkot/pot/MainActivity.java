...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Judul = new String[]{"Home", "Registrasi", "Login", "Tentang Aplikasi",};
        image = new int[]{R.mipmap.home, R.mipmap.register, R.mipmap.login, R.mipmap.informasi,};
        ...
        grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    ...
                    myIntent = new Intent(view.getContext(), KonsultasiActivity.class);
                }
                if (position == 1) {
                    //myIntent = new Intent(view.getContext(), LetakSekolah.class); <!-- contoh Kalo Mau Kasih Intent -->
                    myIntent = new Intent(view.getContext(), DaftarAkun.class);
                }
                if (position == 2) {
